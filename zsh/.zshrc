...
# Force diff to treat both arguments as files
# zstyle ':completion:*:*:diff:*' arguments '(- *)::file:_files' '*:file:_files'
zstyle ':completion:*:*:diff:*' tag-order files
zstyle ':completion:*:*:diff:*' args '*:file:_files'
