...
"							\ destination)
				if exists('$http_proxy')
					let install_command = printf('git clone https://github.com/Shougo/dein.vim.git %s', destination)
				else
					let install_command = printf('git clone git@github.com:Shougo/dein.vim.git %s', destination)
				endif
